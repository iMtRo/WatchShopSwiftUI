...
struct WatchBody: View {
    ...
    @State private var whiteWatch = true
    @State private var whiteWatchAnim = true
            ...
            ZStack{
                ...
                if redWatch{
                    Image("red")
                        ...
                        .animation(Animation.easeInOut(duration: 1).repeatCount(1))
                        .onAppear(){
                            self.redWatchAnim = true
                            self.blueWatchAnim = false
                            self.blackWatchAnim = false
                        }
               }
                ...
                if blueWatch{
                    Image("blue")
                        ...
                        .animation(Animation.easeInOut(duration: 1).repeatCount(1))
                        .onAppear(){
                            self.blueWatchAnim = true
                            self.redWatchAnim = false
                            self.blackWatchAnim = false
                        }
               }
                    ...
                    .gesture(
                        TapGesture()
                            .onEnded({
                                ...
                                self.blueWatch = false
                                self.blackWatch = false
                            })
                    )
